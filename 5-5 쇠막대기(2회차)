...
class Main {
    ...
    public static void main(String[] args) {
        ...
        String request = input.next(); //사용자 입력 받기

        char[] charArray = request.toCharArray(); //입력값 문자 배열로 변환

        int count = 0; //솨파이프 가 잘려진 갯수

        Deque<Character> deque = new ArrayDeque<>(); //문자 배열값을 저장할 스택 생성
